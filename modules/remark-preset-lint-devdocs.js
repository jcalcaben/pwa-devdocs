/**
 * remark preset to configure remark-lint with settings that enforce devdocs styles
 * 
...
module.exports = [
    ...
    [require('./remark-lint-no-undefined-external-references'), ['error'] ] //Custom implementation for checking jekyll-style links
]
